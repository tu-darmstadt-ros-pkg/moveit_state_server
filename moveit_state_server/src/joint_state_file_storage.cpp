...
/* ctor & helpers                                     */
/* -------------------------------------------------- */
JointStateFileStorage::JointStateFileStorage( std::string folder_path, std::string robot_name )
    : JointStateStorage( std::move( robot_name ) ), folder_path_( std::move( folder_path ) )
{
...
bool JointStateFileStorage::getStoredJointState( const std::string &name,
                                                 sensor_msgs::msg::JointState &out, bool /*reload*/ )
{
                                             ...
                                             const std::string &name )
{
  const std::string file =
      ( fs::path( folder_path_ ) / ( robot_name_ + "_" + name + extension_ ) ).string();
