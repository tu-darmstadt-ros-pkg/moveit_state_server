...
inline void convert(const geometry_msgs::msg::Transform &tf,
...
private:
  /* -------- services -------- */
  void storePoseService(
      const std::shared_ptr<moveit_state_server_msgs::srv::StorePose::Request>  request,
